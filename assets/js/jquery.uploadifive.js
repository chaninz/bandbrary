        ...
        init : function(options) {
            ...
            return this.each(function() {
                ...
                $data.removeQueueItem = function(file, instant, delay) {
                    ...
                    if (file.queueItem) {
                        if (file.queueItem.find('.fileinfo').html() != ' - เสร็จสิ้น') {
                            file.queueItem.find('.fileinfo').html(' - ยกเลิก');
                        }
                    ...
                    if ($.inArray('onError', settings.overrideEvents) < 0) {
                        ...
                        switch(errorType) {
                            ...
                            case 'FORBIDDEN_FILE_TYPE':
                                errorMsg = 'ไฟล์ผิดประเภท';
                                break;
                            case 'FILE_SIZE_LIMIT_EXCEEDED':
                                errorMsg = 'ขนาดไฟล์ใหญ่กว่ากำหนด';
                                break;
                            default:
                ...
                $data.uploadComplete = function(e, file, uploadAll) {
                    if ($.inArray('onUploadComplete', settings.overrideEvents) < 0) {
                        ...
                        file.queueItem.find('.fileinfo').html(' - เสร็จสิ้น');
                ...
                if (window.File && window.FileList && window.Blob && (window.FileReader || window.FormData)) {
                    ...
                    $data.button = $('<div id="' + settings.id + '">' + settings.buttonText + '</div>');
