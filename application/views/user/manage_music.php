		...
		<div class="row">
			...
			<div class="col-xs-6">
				<div class="ui form segment" style="text-align: center; padding-top: 40px; padding-bottom: 40px">
					<div class="field">
						<a href="<?php echo base_url('album/user/add'); ?>" ><input class="ui small black submit button" style="margin-bottom: 10px;" type="submit" value="สร้างอัลบั้มใหม่"> </a>
					...
					<div class="field">
						<a href="<?php echo base_url('music/user/add'); ?>" ><input class="ui small red submit button" style="margin-bottom: 10px;" type="submit" value="อัพโหลดเพลง"></a>
						<p>
