...
<head>
	...
	<title><?= $band_profile->name ?> - ไทม์ไลน์ | Bandbrary</title>
	...
	i.circular.icon {
		box-shadow: 0em 0em 0em 0.1em #E72A30 inset;
	}
	</style>
		...
		<article>
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-9">
						<div class="ui piled feed segment" style="margin-top: 20px; width: 689px;">
