...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<?php= base_url('assets/css/jquery-ui.css') ?>">
		...
		<div class="row">
			<div class="col-xs-9">
				<div class="ui form segment">
					<form id="event-form" action="<?= base_url('event/band/edit/'.$event->id) ?>" method="post">
						<h3>แก้ไขตารางงานของวง</h3>
						<br/><p/>
						<div class="line"></div>
						<p/>
						<div class="field">
