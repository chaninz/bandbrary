...
<body>
	...
	<div id="bb-container" class="container">
		...
		<div class="row">
			...
			<div class="col-xs-6">
				<form id="add-job" action="<?= base_url('job/edit/'.$job->id) ?>" method="post"> 
					<div class="ui form segment">
						...
						<div class="field">
							...
							<div class="ui fluid selection dropdown">
								...
								<input type="hidden" name="type" value="<?= $job->type_id ?>"/>
								<div class="menu">
						...
						<div class="field">
							...
							<div class="ui fluid selection dropdown">
								<div class="text">เลือก</div>
								<i class="dropdown icon"></i>
								<input type="hidden" name="style" value="<?= $job->style_id ?>"/>
								<div class="menu">
						...
						<div class="field">
							...
							<div class="ui fluid selection dropdown">
								<div class="text">เลือก</div>
								<i class="dropdown icon"></i>
								<input type="hidden" name="format" value="<?= $job->format_id ?>"/>
								<div class="menu">
						...
						<div class="field">
							<label>สถานที่</label>
							<input type="text" name="venue" value="<?= $job->venue ?>"/>
						</div>
						<div class="field">
							<label>จังหวัด</label>
							<div class="ui labeled icon input">
								<div class="ui fluid selection dropdown">
									<div class="text">เลือก</div>
									<i class="dropdown icon"></i>
									<input type="hidden" name="province" value="<?= $job->province_id ?>">
									<div class="menu"><?php foreach ($provinces as $province): ?>
										<div class="item" data-value="<?= $province->id ?>"><?= $province->province ?></div><?php endforeach; ?>
									</div>
								</div>
							</div>
						</div>
						<div class="field">
							...
							<input type="number" name="budget" value="<?= $job->budget ?>"/>
						</div>
						<div class="date field">
							<label>วันที่</label>
							<div class="ui left labeled icon input">
								<i class="icon calendar"></i>
								<input type="text" placeholder="ปปปป-ดด-วว" name="date" id="date" value="<?= $job->date ?>"/>
							</div>
						</div>
							...
							<div class="two fields">
								<div class="field">
									<label>เวลา</label>
									<div class="ui left labeled icon input">
										<input type="text" placeholder="ชม.นท" name="time" value="<?= mdate("%H:%i", strtotime($job->time)) ?>"/>
										<i class="time icon"></i>
									</div>
								</div>
								<div class="field">
									...
									<div class="ui fluid selection dropdown">
										<div class="text">เลือก</div>
										<i class="dropdown icon"></i>
										<input type="hidden" name="duration" value="<?= $job->duration ?>"/>
										<div class="menu">
